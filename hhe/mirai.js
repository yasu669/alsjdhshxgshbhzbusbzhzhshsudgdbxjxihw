...
console.log(chalk.bold.hex("#FF9000").bold("[ Choru 2.0.2 ] » ") + chalk.bold.hex("#FF9000").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`ChoruBot 2.0.2`, '[ Choru tiktokers ]');
        logger('Hey, thank you for using this Bot', '[ JohnLester ]');
        logger("Fixed by Choru tiktokers", '[ JohnLester ]');
        logger("FB: Choru tiktokers", 'Fixed by Chori TikTokers');
      var cron = require("node-cron");
cron.schedule('0 */10 * * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("ohh kamusta kayo iba dyan ok mag aral kayo mabuti kaysa sige nood nag bold (every 10 minute) \n\nAuto Greet by Choru TikTokers", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Manila"
...
cron.schedule('0 0 6 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good Morning everyone! let's eat breakfast \n\nAuto Greet by Choru TikTokers", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Manila"
...
cron.schedule('0 0 12 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good Afternoon everyone! let's eat lunch\n\nAuto Greet by Choru TikTokers ", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Manila"
...
cron.schedule('0 0 13 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good Afternoon everyone! \n\nAuto Greet by Choru TikTokers", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Manila"
...
cron.schedule('0 0 18 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good Evening everyone! \n\nAuto Greet by Choru TikTokers", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Manila"
...
cron.schedule('0 0 21 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("It's 9:00PM time to sleep Goodnight everyone. \n\nAuto Greet by Choru TikTokers", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Manila"
